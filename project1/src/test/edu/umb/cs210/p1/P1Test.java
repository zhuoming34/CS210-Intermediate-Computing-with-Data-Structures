...
public class P1Test {
    ...
    public static Stream<Arguments> checkStyleArguments() {
        return Stream.of(
                arguments("GreatCircle.java"),
                arguments("PrimeCounter.java"),
                arguments("Distance.java"),
                arguments("Transpose.java"),
                arguments("Rational.java"),
                arguments("Harmonic.java"),
                arguments("Percolation.java"),
                arguments("PercolationStats.java")
        );
    }
    ...
    public class Style_Test {
        ...
        @DisplayName("Checking the coding style of:")
        @MethodSource(packageName+".P1Test#checkStyleArguments")
        public void checkstyle_test(String fileName) {
            ProcessBuilder pb = new ProcessBuilder();
            String cmd =  "check_style " + packagePath + fileName;
            ...
            String actual = lineCount < 3 ? prev : "See warnings for details.";
